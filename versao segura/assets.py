...
CORES = {
    ...
    "ciano": (0, 255, 255),
    "magenta": (255, 0, 255),
    "magenta_opaco": (255, 0, 255, 128),  # Magenta com opacidade
    "ciano_opaco": (0, 255, 255, 128),      # Ciano com opacidade
}
...
# Margem para a barra de tarefas e bordas da janela
...
# Escala uniforme para elementos que não devem ser deformados
...
quadro_fase0 = pygame.transform.scale(
    pygame.image.load("images/quadro_fase0.png"),
    (sx(BASE_LARGURA // 3), sy(BASE_ALTURA // 2 + 50))
)

fundo_fases = pygame.transform.scale(
    pygame.image.load("images/fundo_fases.png"),
    (largura_tela, altura_tela)
)

nuvem = pygame.transform.scale(
    pygame.image.load("images/nuvem.png"),
    (s(300), s(110))
)

cadeado = pygame.transform.scale(
    pygame.image.load("images/cadeado.png"),
    (s(50), s(75))
)

cadeadoaberto = pygame.transform.scale(
    pygame.image.load("images/cadeadoaberto.png"),
    (s(50), s(75))
)

bichinho1 = pygame.transform.scale(
    pygame.image.load("images/bichinho1.png"),
    (s(200), s(180))
)

bichinho2 = pygame.transform.scale(
    pygame.image.load("images/bichinho2.png"),
    (s(200), s(180))
)

bandeira = pygame.transform.scale(
    pygame.image.load("images/bandeira.png"),
    (s(120), s(110))
)

som = pygame.transform.scale(
    pygame.image.load("images/som.png"),
    (s(300), s(300))
)
...
botao_sair_rect, surf_sair, txt_sair, txt_sair_rect = criar_botao(
    "Sair",
    sx(700 - 200),
    sy(400 + 150),
    s(400),
...
botao_ajuda_rect, surf_ajuda, txt_ajuda, txt_ajuda_rect = criar_botao(
    "Ajuda",
    sx(700 - 200),
    sy(400 + 50),
    s(400),
...
botao_jogar_rect, surf_jogar, txt_jogar, txt_jogar_rect = criar_botao(
    "Jogar",
    sx(700 - 200),
    sy(400 - 50),
    s(400),
...
botao_fase1_rect, surf_fase1, txt_fase1, txt_fase1_rect = criar_nuvem(
    "Fase 1",
    inicio_nuvens,
    sy(BASE_ALTURA // 2 - 10),
    s(200),
...
botao_nuvem2_rect, surf_nuvem2, txt_nuvem2, txt_nuvem2_rect = criar_nuvem(
    "Fase 2",
    inicio_nuvens + largura_botao_nuvem + espaco_nuvens,
    sy(BASE_ALTURA // 2 - 10),
    s(200),
    s(20)
)

botao_nuvem3_rect, surf_nuvem3, txt_nuvem3, txt_nuvem3_rect = criar_nuvem(
    "Fase 3",
    inicio_nuvens + (largura_botao_nuvem + espaco_nuvens) * 2,
    sy(BASE_ALTURA // 2 - 10),
    s(200),
    s(20)
)
...
botao_comecar_rect, surf_comecar, txt_comecar, txt_comecar_rect = criar_botao(
    "Começar",
    sx(BASE_LARGURA - 300),
    sy(BASE_ALTURA - 150),
    s(240),
...
botao_voltar_rect, surf_voltar, txt_voltar, txt_voltar_rect = criar_botao(
    "Voltar",
    sx(BASE_LARGURA // 15),
    sy(BASE_ALTURA // 17),
    s(240),
...
botao_avancar_rect, surf_avancar, txt_avancar, txt_avancar_rect = criar_botao(
    "Avançar",
    sx(BASE_LARGURA // 2 - 120),
    sy(BASE_ALTURA - 200),
    s(240),
    s(56)
)
...
som1_rect = som.get_rect(
    topleft=(inicio_sons, sy(400))
)

som2_rect = som.get_rect(
    topleft=(inicio_sons + som.get_width() + espaco_botoes_som, sy(400))
)

som3_rect = som.get_rect(
    topleft=(sx(BASE_LARGURA // 2 - 150), sy(400))
)
...
borda_botao1_resposta_rect = pygame.Rect(
    som1_rect.x - s(5),
    sy(395),
    s(310),
    s(310)
...
borda_botao2_resposta_rect = pygame.Rect(
    som2_rect.x - s(5),
    sy(395),
    s(310),
    s(310)
...
botao1_resposta1_rect, surf_botao1_resposta1, txt_botao1_resposta1, txt_botao1_resposta1_rect = criar_botao(
    "SOM 1",
    som1_rect.x,
    sy(400),
    s(300),
...
botao2_resposta1_rect, surf_botao2_resposta1, txt_botao2_resposta1, txt_botao2_resposta1_rect = criar_botao(
    "SOM 2",
    som2_rect.x,
    sy(400),
    s(300),
...
botao1_resposta3_rect, surf_botao1_resposta3, txt_botao1_resposta3, txt_botao1_resposta3_rect = criar_botao(
    "IGUAIS",
    som1_rect.x,
    sy(400),
    s(300),
...
botao2_resposta3_rect, surf_botao2_resposta3, txt_botao2_resposta3, txt_botao2_resposta3_rect = criar_botao(
    "DIFERENTES",
    som2_rect.x,
    sy(400),
    s(300),
...
botao1_resposta2_rect, surf_botao1_resposta2, txt_botao1_resposta2, txt_botao1_resposta2_rect = criar_botao(
    "GUITARRA\n\nPIANO\n\nBATERIA",
    som1_rect.x,
    sy(400),
    s(300),
...
botao2_resposta2_rect, surf_botao2_resposta2, txt_botao2_resposta2, txt_botao2_resposta2_rect = criar_botao(
    "PIANO\n\nSAXOFONE\n\nVIOLINO",
    som2_rect.x,
    sy(400),
    s(300),
...
usuario = pygame.Rect(
    sx(BASE_LARGURA // 2 - 200),
    sy(BASE_ALTURA // 2 - 50),
    s(400),
    s(50)
)

idade_rect = pygame.Rect(
    sx(BASE_LARGURA // 2 - 200),
    sy(BASE_ALTURA // 2 + 50),
    s(400),
    s(50)
...
serie_rect = pygame.Rect(
    sx(BASE_LARGURA // 2 - 200),
    sy(BASE_ALTURA // 2 + 150),
    s(400),
    s(50)
)
...
texto_som1_surface = FONT.render(
    "SOM 1",
    True,
    CORES["preto"]
)
...
texto_som1_rect = texto_som1_surface.get_rect(
    center=(sx(BASE_LARGURA // 2 - 450), sy(550))
)


texto_som2_surface = FONT.render(
    "SOM 2",
    True,
    CORES["preto"]
)
...
texto_som3_surface = FONT.render(
    "MÚSICA",
    True,
    CORES["preto"]
)
...
texto_som3_rect = texto_som3_surface.get_rect(
    center=(sx(BASE_LARGURA // 2), sy(550))
)


texto_intro1_surf = fonte_intro.render(
    "FASE 1",
    True,
    CORES["preto"]
)
...
texto_intro1_rect = texto_intro1_surf.get_rect(
    center=(sx(BASE_LARGURA // 2), sy(BASE_ALTURA // 2))
)


texto_intro2_surf = fonte_intro.render(
    "FASE 2",
    True,
    CORES["preto"]
)
...
texto_intro3_surf = fonte_intro.render(
    "FASE 3",
    True,
    CORES["preto"]
)
...
texto_relatorio_surf = fonte_relatorio_titulo.render(
    "Relatório Final",
    True,
    CORES["preto"]
)

texto_relatorio_rect = texto_relatorio_surf.get_rect(
    center=(sx(BASE_LARGURA * 2 / 10),
            sy(BASE_ALTURA * 2 / 10))
)
